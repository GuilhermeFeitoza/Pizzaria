<template>
 ...
 <h1 style="font-family: Calibri;">Últimos pedidos</h1>
   <div style="display:inline-flex;">
    <div  class="card"
    v-for="pedido in pedidos" :key="pedido.index" style="border-style:solid; margin-left:15px">
      <img id="imgpedido" :src="pedido.img" />
      <ul v-for="item in itemsPedido" :key="item.id">
        <li>{{ item.nome }}</li>
      </ul>
    </div>
   </div>
